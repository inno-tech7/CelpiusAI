...
export function HeroSection() {
  return (
    <section className="relative h-[89rem] overflow-hidden sm:pt-[10rem] md:pt-[5rem] lg:pb-[30rem] lg:pt-[6rem] max-1024:h-[95rem] max-820:h-[86rem] max-768:h-[79rem] max-768:pt-[1rem] max-435:h-[65rem] max-435:pt-[0rem]">
      {/* <Image
      ...
      <div className="relative z-[2] mx-auto mt-[6rem] max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="mb-[14rem] px-8 max-1024:mb-[17rem] max-820:pt-[3rem] max-768:mb-[11rem]">
          <div className="flex flex-col items-center text-center max-1024:items-center max-1024:text-center">
            <motion.p
              ...
              className="gradient-text mb-3 max-w-xl text-lg uppercase leading-relaxed tracking-[1rem] sm:text-xl"
            >
              Get started
            </motion.p>
            ...
            <motion.h1
              ...
              whileInView={'show'}
              viewport={{ once: true, amount: 0.6 }}
              className="mb-6 w-[50%] max-w-3xl text-4xl font-bold tracking-tight text-slate-600 dark:text-slate-100 sm:text-5xl lg:text-6xl max-1024:w-[67%] max-435:w-[72%] max-415:w-[77%]"
            >
            ...
            <motion.p
              ...
              whileInView={'show'}
              viewport={{ once: true, amount: 0.6 }}
              className="mb-10 max-w-xl text-lg leading-relaxed tracking-[0rem] text-slate-700 dark:text-slate-300 sm:text-xl"
            >
              Experience the future of CELPIP preparation with real-time AI feedback, emotional
              analysis, and adaptive learning paths tailored to your success.
            </motion.p>
            ...
            >
              <Link href="/auth/signup">
                <SpottyBtn
                  size="lg"
                  className="group w-full scale-[1.20] transform font-mono font-[400] text-white transition-transform hover:scale-[1.25] sm:w-auto max-435:scale-[0.9]"
                >
                  Start Free Trial
            ...
            <div className="mt-[11rem] flex justify-center max-435:mt-[4rem] max-435:scale-[0.5]">
              <CardSwap cardDistance={0} verticalDistance={5} delay={5000} pauseOnHover={false}>
