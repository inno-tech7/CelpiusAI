...
import { LayoutDashboard, Pencil, Users, Server, CreditCard, LogOut } from 'lucide-react';
          ...
          <div className="border-b border-white/10 px-6 py-6">
            <Link href="/" className="flex items-center justify-center">
              <Image
                ...
                width={160}
                height={54}
                className="h-[2.5rem] w-auto scale-[0.8]"
              />
            </Link>
          </div>

          {/* Navigation Items */}
          <nav className="admin-sidebar-nav flex-1 overflow-y-auto pb-6 pt-6">
