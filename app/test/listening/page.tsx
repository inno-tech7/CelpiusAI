    ...
    questions: [
      {
        ...
        correctAnswer: 0,
        explanation:
          'The conversation centers around a malfunctioning computer system, which is the primary issue being discussed.',
      },
      {
        id: 2,
        ...
        correctAnswer: 3,
        explanation:
          'The woman suggests that the IT department should be contacted to resolve the computer system issue.',
      },
      {
        id: 3,
        ...
        correctAnswer: 1,
        explanation:
          "The man agrees with the woman's suggestion, stating that it is a good idea to involve the IT department.",
      },
    ],
  },
  {
    ...
    questions: [
      {
        ...
        correctAnswer: 1,
        explanation:
          "The conversation explicitly mentions that they plan to meet at Sarah's house before heading out.",
      },
      {
        id: 5,
        ...
        correctAnswer: 2,
        explanation:
          'After some discussion, the speakers decide that 3:00 PM is the most convenient time for both of them to meet.',
      },
      {
        id: 6,
        ...
        correctAnswer: 2,
        explanation:
          'Tom mentions that he needs to complete his homework before he can join the planned weekend activity.',
      },
    ],
  },
  {
    ...
    questions: [
      {
        ...
        correctAnswer: 0,
        explanation:
          "The announcement's primary goal is to inform listeners about the upcoming changes to the library's operating hours.",
      },
      {
        id: 8,
        ...
        correctAnswer: 1,
        explanation:
          'The announcement clearly states that the new library hours will begin on the upcoming Monday.',
      },
      {
        id: 9,
        ...
        correctAnswer: 1,
        explanation:
          'Listeners are advised to go to the information desk for any further questions or clarifications.',
      },
    ],
  },
  {
    ...
    questions: [
      {
        ...
        correctAnswer: 0,
        explanation:
          'The news report describes a community event that was organized to raise funds for a charitable cause.',
      },
      {
        id: 11,
        ...
        correctAnswer: 2,
        explanation:
          'The report specifies that the fundraiser successfully collected a total of $35,000 for the cause.',
      },
      {
        id: 12,
        ...
        correctAnswer: 2,
        explanation:
          'The funds raised are designated to provide financial assistance to families in the local community.',
      },
    ],
  },
  {
    ...
    questions: [
      {
        ...
        correctAnswer: 0,
        explanation:
          'Maria expresses a preference for studying in groups, as she finds it more engaging and collaborative.',
      },
      {
        id: 14,
        ...
        correctAnswer: 1,
        explanation:
          'John states that he finds group study sessions distracting, which hinders his ability to concentrate effectively.',
      },
      {
        id: 15,
        ...
        correctAnswer: 2,
        explanation:
          'Despite their different study preferences, both Maria and John acknowledge the importance of using practice tests to prepare.',
      },
    ],
  },
  {
    ...
    questions: [
      {
        ...
        correctAnswer: 1,
        explanation:
          'The woman argues that remote work allows for a better balance between professional and personal life.',
      },
      {
        id: 17,
        ...
        correctAnswer: 0,
        explanation:
          'The man is concerned that remote work can make it more challenging for team members to collaborate effectively.',
      },
      {
        id: 18,
        ...
        correctAnswer: 2,
        explanation:
          'Both speakers agree that a hybrid model, combining remote and in-office work, is a practical compromise.',
      },
    ],
  },
];
...
export default function ListeningTestPage() {
  ...
  const proceedToNextQuestion = () => {
    ...
    if (
      currentPart > furthestQuestionReached.part ||
      (currentPart === furthestQuestionReached.part &&
        currentQuestion >= furthestQuestionReached.question)
    ) {
  ...
  const handleNextQuestion = () => {
    ...
    if (
      ...
      !(
        ...
        currentQuestion === listeningParts[currentPart]?.questions.length - 1
      )
    ) {
      setShowWarning(true);
    } else {
        ...
        >
          <Card className="border-slate-700/50 bg-slate-800/30 backdrop-blur-sm">
            <CardHeader className="text-center">
              <CardTitle className="text-3xl text-white">Listening Test Results</CardTitle>
            ...
            <CardContent className="space-y-6">
              ...
              <div className="grid grid-cols-1 gap-4 md:grid-cols-3">
                ...
                <div className="rounded-lg bg-slate-700/30 p-4 text-center">
                  ...
                  <p className="mx-auto max-w-md text-slate-400">{/* proficiency.description */}</p>
                </div>
              </div>

              <div className="pt-4">
                <h3 className="mb-4 text-center text-2xl font-bold text-blue-400">
                  Detailed Feedback
                </h3>
                        ...
                        <AccordionItem key={question.id} value={`item-${index}`}>
                          <AccordionTrigger className="hover:no-underline">
                            <div className="flex w-full items-center justify-between">
                              ...
                              {isCorrect ? (
                                <CheckCircle className="ml-4 h-5 w-5 text-green-500" />
                              ) : (
                                <XCircle className="ml-4 h-5 w-5 text-red-500" />
                              )}
                            </div>
                          </AccordionTrigger>
                          <AccordionContent className="card-outline space-y-2 p-4 text-slate-300">
                            <p className="flex">
                              <strong className="mr-2 flex-shrink-0 text-blue-400">
                                Your Answer:
                              </strong>
                              <span
                                className={`break-words ${isCorrect ? 'text-green-400' : 'text-red-400'}`}
                              >
      ...
      <div className="card-outline font-sans text-white">
          ...
          <AlertDialogContent className="border-slate-700 bg-slate-800 text-white">
            <AlertDialogHeader>
              ...
              <AlertDialogDescription className="text-slate-400">
                You have not selected an answer for this question. On the official test, you will
                not be able to return to this question after moving to the next page.
              </AlertDialogDescription>
            </AlertDialogHeader>
            <AlertDialogFooter>
              <AlertDialogCancel className="border-slate-600 bg-slate-700 font-mono hover:bg-slate-600">
                Cancel
              </AlertDialogCancel>
              <AlertDialogAction
                onClick={() => {
        ...
        <header className="flex items-center justify-between rounded-t-[23px] border-[1px] border-b-[#3b4687] bg-blue-950/0 p-4 max-435:flex-col max-435:items-start">
          <h1 className="max-w-[70%] font-mono text-lg font-semibold text-blue-400 max-435:pb-[2rem]">
            Practice Test A - Listening Part {currentPart + 1}: Listening to Problem Solving
          </h1>
          <div className="flex items-center space-x-4 max-435:space-x-40">
            <span className="text-sm text-slate-400 max-435:flex max-435:flex-col">
              Time remaining:{' '}
        ...
        <main className="grid gap-6 md:grid-cols-2 max-1024:grid-cols-1">
          {/* Left Column */}
          <div className="flex flex-col border-r border-slate-700 p-4 sm:p-6 md:p-8 max-1024:border-r-0">
            <div className="flex-grow">
              <div className="mb-4 flex items-center rounded-md bg-blue-900/0 p-3">
                ...
                <p className="font-mono font-semibold text-blue-400">{currentPartData.title}</p>
              </div>

              <div className="space-y-4 rounded-md border border-slate-700 bg-slate-800/0 p-4">
                <div className="flex h-24 items-center justify-center rounded-lg bg-slate-700/50 p-4">
                  {!hasPlayedAudio ? (
                    ...
                    <div className="flex w-full items-center space-x-4">
                      ...
                      <div className="w-full">
                        <p className="mb-1 pb-[0.5rem] text-center text-slate-300">Playing...</p>
                        <Progress value={audioProgress} className="mb-[2rem] h-2 bg-slate-600" />
                      </div>
                    </div>
                  )}
                </div>
                <div className="flex items-center rounded-lg bg-slate-900/70 p-3">
                  <button
                    onClick={handlePlayAudio}
                    disabled={isAudioFinished}
                    className="scale-[0.6] rounded-full bg-transparent p-2 hover:bg-slate-700 disabled:cursor-not-allowed disabled:opacity-50"
                  >
                    {isPlaying ? (
                  ...
                  <span className="w-[8rem] text-center font-mono text-sm text-slate-400">
                    {formatTime(audioCurrentTime)} / {formatTime(audioDuration)}
                  </span>

                  <div className="ml-auto flex w-32 items-center space-x-2">
                ...
                />
                <p className="rounded-md border border-slate-600 p-2 text-center text-sm text-slate-400">
          ...
          <div className="flex flex-col rounded-md bg-slate-800/0 p-4 sm:p-6 md:p-8">
            <div className="flex-grow">
              <p className="mb-2 font-mono font-semibold text-blue-400">
              ...
              >
                {currentQuestionData.options.map((option, index) => (
                  <div
                    key={index}
                    className="flex items-center rounded-md p-2 hover:bg-slate-700/50"
                  >
                    <RadioGroupItem
                      value={index.toString()}
                      id={`option-${index}`}
                      className="mr-3 border-slate-600"
                    />
                    <Label htmlFor={`option-${index}`} className="font-normal text-slate-300">
                      {option}
                    </Label>
                  </div>
                ))}
