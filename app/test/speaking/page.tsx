...
export default function SpeakingTestPage() {
        ...
        >
          <Card className="border-slate-700/50 bg-slate-800/30 backdrop-blur-sm">
            <CardHeader className="text-center">
              <CardTitle className="text-3xl text-white">Speaking Test Results</CardTitle>
            ...
            <CardContent className="space-y-6">
              ...
              <div className="grid grid-cols-1 gap-4 md:grid-cols-3">
                ...
                <div className="rounded-lg bg-slate-700/30 p-4 text-center">
                  <div className="text-2xl font-bold text-blue-400">
                    {speakingTasks.length - completedTasks}
                  </div>
              ...
              <div className="rounded-lg bg-slate-700/30 p-4">
                <h3 className="mb-3 font-semibold text-white">AI Feedback (Simulated)</h3>
  ...
  return (
    <DashboardLayout>
      <div className="card-outline flex h-full flex-col font-sans text-slate-900 dark:bg-slate-900 dark:text-white">
        <header className="flex items-center justify-between rounded-t-[23px] border-[1px] border-b-[#3b4687] bg-blue-950/0 p-4 max-435:flex-col max-435:items-start">
          <h1 className="max-w-[50%] font-mono text-lg font-semibold text-blue-400 max-435:max-w-[90%] max-435:pb-[2rem]">
            Practice Test A - {currentTaskData.title}
          </h1>
          <div className="flex items-center space-x-4 max-435:space-x-14">
            <span className="text-sm text-slate-500 dark:text-slate-400 max-820:flex max-820:flex-col">
              ...
              <span className="font-bold text-slate-700 dark:text-slate-200">
                {currentTaskData.preparationTime} seconds
              </span>
            </span>
            ...
            <span className="text-sm text-slate-500 dark:text-slate-400 max-820:flex max-820:flex-col">
              Recording:{' '}
              <span className="font-bold text-slate-700 dark:text-slate-200">
                {currentTaskData.speakingTime} seconds
              </span>
            </span>
            <Button
        ...
        <main className="flex flex-grow flex-col items-center justify-center pt-6">
          <div className="w-full max-w-[96%]">
            <div className="mb-8 flex items-start rounded-md bg-blue-100 p-3 dark:bg-blue-900/0">
              <AlertCircle className="mr-3 mt-1 flex-shrink-0 text-blue-500 dark:text-blue-400" />
              <p className="font-semibold text-blue-800 dark:text-blue-300">
                {currentTaskData.prompt}
              </p>
            </div>

            <div className="card-outline mx-auto my-8 flex w-full max-w-md items-center justify-center space-x-8 rounded-lg p-8">
              <Clock className="h-12 w-12 text-slate-500 dark:text-slate-400" />
              <div className="text-center">
                <p className="text-xl font-semibold capitalize text-slate-700 dark:text-slate-300">
                  {phase} Time
                </p>
            ...
            <p className="mb-[12.5rem] mt-8 text-left text-sm text-slate-500 dark:text-slate-400">
