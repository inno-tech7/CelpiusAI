    ...
    parts: [
      {
        ...
        description: 'A conversation between two or more people trying to solve a problem',
      },
      {
        number: 2,
        name: 'Listening to a Daily Life Conversation',
        description: 'An informal conversation about an everyday topic',
      },
      {
        number: 3,
        name: 'Listening for Information',
        description: 'A monologue, such as an announcement or news report',
      },
      { number: 4, name: 'Listening to a News Item', description: 'A short news broadcast' },
      {
        number: 5,
        name: 'Listening to a Discussion',
        description: 'Audio and Video: Discussion among several people with video component',
      },
      {
        number: 6,
        name: 'Listening to Viewpoints',
        description: 'A monologue or discussion where speakers present and defend opinions',
      },
    ],
  },
  reading: {
    parts: [
      {
        ...
        description:
          'Read an email or letter and answer questions, including choosing best response',
      },
      {
        number: 2,
        name: 'Reading to Apply a Diagram',
        description: 'Use both diagram/chart/schedule and related text to answer questions',
      },
      {
        number: 3,
        name: 'Reading for Information',
        description: 'Read informational text like news article and answer factual questions',
      },
      {
        number: 4,
        name: 'Reading for Viewpoints',
        description:
          'Complex text with different opinions, identify viewpoints and supporting details',
      },
    ],
  },
  speaking: {
    parts: [
      {
        number: 1,
        name: 'Giving Advice',
        description: 'Give advice to a friend or family member about a problem',
      },
      {
        number: 2,
        name: 'Talking about a Personal Experience',
        description: 'Tell a short story about a personal experience',
      },
      {
        number: 3,
        name: 'Describing a Scene',
        description: 'Describe what is happening in a picture in detail',
      },
      {
        number: 4,
        name: 'Making Predictions',
        description: 'Predict what will happen next based on the image from Task 3',
      },
      {
        number: 5,
        name: 'Comparing and Persuading',
        description: 'Choose one option and persuade someone it is better, comparing two options',
      },
      {
        number: 6,
        name: 'Dealing with a Difficult Situation',
        description: 'Resolve a difficult situation in a polite and effective way',
      },
      {
        number: 7,
        name: 'Expressing Opinions',
        description: 'State your opinion and provide reasons and examples to support it',
      },
      {
        number: 8,
        name: 'Describing an Unusual Situation',
        description: 'Describe an unusual object/scene to someone who cannot see it',
      },
    ],
  },
  writing: {
    parts: [
      {
        ...
        description: '27 minutes, 150-200 words. Write email response with appropriate tone',
      },
      {
        number: 2,
        name: 'Responding to Survey Questions',
        description: '26 minutes, 150-200 words. Choose and justify one option from survey',
      },
    ],
  },
};
...
const initialMockQuestions: CELPIPQuestion[] = [
  {
    ...
    instructions:
      'Listen to the conversation between two people discussing a problem. Answer the questions based on what you hear.',
    options: [
  ...
  },
  {
    ...
    taskType: 'email',
    prompt:
      'Your friend has asked for advice about choosing between two job offers. Write an email giving your friend advice. In your email, you should: • Ask for more details about both positions • Give your opinion on which job might be better • Suggest what factors your friend should consider',
    instructions:
      'Write an email response. Choose an appropriate tone (formal, semi-formal, or informal) based on the recipient.',
  ...
  },
  {
    ...
    prompt:
      'Describe what is happening in this picture. Talk about the people, objects, activities, and setting. Provide as much detail as possible.',
    instructions:
      'Look at the picture and describe what you see. You have 30 seconds to prepare and 60 seconds to speak.',
...
export default function ContentManagementPage() {
  ...
  const handleAddQuestion = () => {
    ...
    if (
      newQuestion.section === 'speaking' &&
      [3, 4, 5, 8].includes(newQuestion.part!) &&
            ...
            <CardHeader>
              ...
              <CardDescription>
                {editingQuestion
                  ...
                  : 'Create a new question for the CELPIP test'}
              </CardDescription>
            </CardHeader>
            <CardContent className="space-y-6">
              <div className="grid grid-cols-1 gap-4 md:grid-cols-3">
                <div className="space-y-2">
                  <Label>Section *</Label>
                  <Select value={newQuestion.section} onValueChange={handleSectionChange}>
              ...
              <div className="space-y-2">
                ...
                <Textarea
                  ...
                  className="glass-card min-h-[100px] border-white/10"
                />
              </div>
              ...
              <div className="space-y-2">
                ...
                <Textarea
                  ...
                  className="glass-card min-h-[80px] border-white/10"
                />
              </div>
              ...
              <div className="space-y-4">
                ...
                <div className="grid grid-cols-1 gap-4 md:grid-cols-3">
                  ...
                  <div className="space-y-2">
                    ...
                    <div className="rounded-lg border-2 border-dashed border-white/20 p-4 text-center">
                      <input
                        type="file"
                        accept="audio/*"
                        onChange={(e) => {
                      ...
                      {newQuestion.mediaFiles?.audio && (
                        <p className="mt-2 text-xs text-green-400">Audio uploaded</p>
                      )}
                    </div>
                  </div>
                      ...
                      {newQuestion.options?.map((option, index) => (
                        <div key={`option-${index}`} className="flex items-center space-x-2">
                          ...
                          <Input
                            ...
                            className="glass-card flex-1 border-white/10"
                          />
                        </div>
                      ))}
                    </div>
              ...
              <div className="space-y-2">
                ...
                <p className="text-xs text-muted-foreground">
                  For listening questions, provide an audio file URL. For reading questions, provide
                  an image URL if needed.
                </p>
              </div>

              <div className="flex space-x-2 border-t border-white/10 pt-4">
                <Button
                ...
                <CardContent>
                  ...
                  {expandedQuestions.has(question.id) && (
                    <div className="space-y-4 border-t border-white/10 pt-4">
                      <div>
                        <p className="mb-2 text-sm font-medium">Full Prompt:</p>
                        <p className="rounded-lg bg-black/20 p-3 text-sm text-muted-foreground">
                          {question.prompt}
                        </p>
                      </div>
                      ...
                      {question.mediaUrl && (
                        <div>
                          ...
                          <p className="rounded bg-black/20 p-2 font-mono text-sm text-blue-400">
                            {question.mediaUrl}
                          </p>
                        </div>
                      )}
